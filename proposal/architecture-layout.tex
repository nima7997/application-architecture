...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|}
		...
		\hline
		منبع محرک & اپراتور فروشگاه، خریداران اینترنتی، سخت افزار، نرم افزار و زیرساخت فیزیکی \\
...
\begin{enumerate}
	...
	\item  قطع شدن سرویس مدیریت فروشگاه با باقی سرویس‌ها
	\item خرابی سرویس اهرازهویت
...
\begin{enumerate}
	...
	\item ثبت تراکنش‌های همزمان از چند صد فروشگاه
\end{enumerate}
\begin{table}[h]
	\centering
	...
	\begin{tabular}{|c|c|}
		...
		\hline	
				...
				معیار سنجش & میزان تطابق با سرویس‌های جدید، توانایی برقراری ارتباط به صورت درصدی مربوط به هر بخش ارتباطی با سرویس جدید	\\	
		\hline
	\end{tabular}
\end{table}
...
سناریوهای مختص در کارایی این نرم افزار عبارتند از: 
\begin{enumerate}
	\item قابلیت افزودن سرویس‌هایی مانند حسابداری، مدیریت تامیین بدون نیاز به تغییر ماهیت سرویس‌ها
	\item قابلیت اتصال به سرویس \lr{ERP}
\end{enumerate}
\begin{figure}[h]
	\centering
